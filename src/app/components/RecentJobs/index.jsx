                ...
                <div className='container'>
                    <div className='wrapper relative z-[99]'>
                        <div className='flex items-center justify-between'>
                            <div className='col1'>
                                <h2 className='text-white text-[30px] font-bold'>Recent Job Related News</h2>
                                <p class="text-[16px] text-gray-100">Read our latest news. Be always in trend with daily news.</p>
                            </div>


                            <Button className='btn-custom'><span>Read More</span></Button>
