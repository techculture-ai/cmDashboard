    ...
    try {
      ...
      if (result.success) {
        ...
        setProposalData({
          ...
          departmentSubmitted: data.departmentSubmitted || "",
          officerSubmitted: data.officerSubmitted || "",
          actionTaken: data.actionTaken || "",
          status: data.status || "",
          lastLogin: data.lastLogin || "",
          letterFile: data.letterFile || null,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
      <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <Typography variant="h4" className="font-bold mb-2">
                    💡 Innovative Proposal Details
                  </Typography>
                  <Typography variant="body1" className="text-purple-100">
                    View innovative proposal information and current status
                  </Typography>
                </div>
              </div>
          ...
          <CardContent className="p-0">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InfoRow
                  label="Serial Number"
                  value={proposalData.serialNo}
                  icon={SlCalender}
                />
                <InfoRow
                  label="Institution/Individual/Company Name"
                  value={proposalData.institutionName}
                  icon={HiOutlineOfficeBuilding}
                />
                <InfoRow
                  label="Date of Submission"
                  value={formatDate(proposalData.dateOfSubmission)}
                  icon={BsCalendarDate}
                />
                <InfoRow
                  label="District"
                  value={proposalData.district}
              ...
              <div>
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                  <Typography className="text-gray-900 dark:text-white leading-relaxed">
                    {proposalData.details || "No details provided"}
                  </Typography>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InfoRow
                  ...
                  value={proposalData.representative.name}
                  icon={SlCalender}
                />
                <InfoRow
                  label="Representative Contact"
                  value={proposalData.representative.contact}
                  icon={SlCalender}
                />
              </div>
            </div>
        ...
        <Card className="shadow-lg border-0 overflow-hidden mb-8">
          <CardContent className="p-0">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <InfoRow
                  label="Department Submitted To"
                  value={proposalData.departmentSubmitted}
                  icon={HiOutlineOfficeBuilding}
                />
                <InfoRow
                  label="Officer Submitted To"
                  value={proposalData.officerSubmitted}
                  icon={SlCalender}
                />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                    ...
                    <Chip
                      label={proposalData.status || "Not specified"}
                      color={getStatusColor(proposalData.status)}
                      className="font-semibold"
                    />
                  </div>
                </div>

                {proposalData.lastLogin && (
                  <InfoRow
                    label="Last Login by Department"
                    value={new Date(proposalData.lastLogin)
                      .toString()
                      .split("GMT")[0]
                      .trim()}
                    icon={BsCalendarDate}
        ...
        {(proposalData.letterFile ||
          proposalData.pictureFile ||
          proposalData.documentUpload) && (
          <Card className="shadow-lg border-0 overflow-hidden mb-8">
            <CardContent className="p-0">
                  ...
                  {proposalData.documentUpload && (
                    <div className="text-center">
                      <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border-2 border-dashed border-blue-200 dark:border-blue-600">
                        ...
                        <button
                          onClick={() =>
                            downloadDocument(proposalData.documentUpload)
                          }
                  ...
                  {proposalData.letterFile && (
                    <div className="text-center">
                      <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border-2 border-dashed border-green-200 dark:border-green-600">
                        ...
                        <button
                          onClick={() =>
                            downloadDocument(proposalData.letterFile)
                          }
                    ...
                    <div className="text-center">
                      <div className="p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl border-2 border-dashed border-purple-200 dark:border-purple-600">
                        <div className="flex flex-col items-center">
                          ...
                          <button
                            onClick={() =>
                              downloadDocument(proposalData.pictureFile)
                            }
