    ...
    try {
      ...
      if (result.success) {
        ...
        setSchemeData({
          ...
          dateOfApproval: data.dateOfAnnouncement || data.dateOfApproval || "",
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <Typography variant="h4" className="font-bold mb-2">
                    State Government Scheme Details
                  </Typography>
                  <Typography variant="body1" className="text-purple-100">
                    View state government scheme information and status
                  </Typography>
                </div>
              </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  {schemeData.pictureUpload && (
                    <div className="text-center">
                      <div className="p-6 bg-pink-50 dark:bg-pink-900/20 rounded-xl border-2 border-dashed border-pink-200 dark:border-pink-600">
                        <IoImageOutline
...
export default SchemeStateView;
