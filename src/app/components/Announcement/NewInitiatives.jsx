...
const NewInitiative = () => {
  ...
  }, [id, mounted, isEditMode, fetchInitiativeData, fetchDepartments]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("initiativeName", initiativeName);
      ...
      const res = await fetch(
        isEditMode
          ? `${process.env.NEXT_PUBLIC_BASE_URL}/api/new-initiatives/${id}`
          : `${process.env.NEXT_PUBLIC_BASE_URL}/api/new-initiatives`,
        {
      ...
      toast.success("New Initiative submitted successfully!");
            ...
            <div className="flex items-center justify-between">
              <div>
                <Typography variant="h4" className="font-bold mb-2">
                  {isEditMode ? "Edit" : "Create"} New Initiative
                </Typography>
                <Typography variant="body1" className="text-green-100">
                  {isEditMode
                    ? "Update existing initiative details"
                    : "Submit new government initiatives and track their progress"}
                </Typography>
              </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-gray-700 dark:text-gray-300 font-semibold text-sm flex items-center gap-2">
                      <HiOutlineLightBulb /> Initiative Name
                    </label>
                    <input
                      type="text"
                      className="w-full h-12 border-2 border-gray-200 dark:border-gray-600 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl px-4 bg-white dark:bg-gray-700 transition-all duration-300 hover:border-gray-300"
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <textarea
                    ...
                    placeholder="Brief details about the new initiative"
                    value={details}
          ...
          <Card className="shadow-lg border-0 overflow-hidden">
            <CardContent className="p-6">
              <div className="flex items-center justify-end gap-4">
                ...
                <Button
                  variant="contained"
                  className="!bg-gradient-to-r !from-green-600 !to-teal-600 hover:!from-green-700 hover:!to-teal-700 !rounded-xl !px-8 !py-3 !font-semibold !shadow-lg hover:!shadow-xl !transition-all !duration-300 !transform hover:!scale-105"
                  onClick={handleSubmit}
                >
                  {isEditMode ? "Update Initiative" : "Submit Initiative"}
                </Button>
              </div>
            </CardContent>
          </Card>
