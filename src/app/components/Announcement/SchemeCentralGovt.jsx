  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        isEditMode
          ? `${process.env.NEXT_PUBLIC_BASE_URL}/api/central-govt-schemes/${id}`
          : `${process.env.NEXT_PUBLIC_BASE_URL}/api/central-govt-schemes/`,
        {
            ...
            <div className="flex items-center justify-between">
              <div>
                <Typography variant="h4" className="font-bold mb-2">
                  {isEditMode ? "✏️ Update" : "➕ Create"} Central Government
                  Scheme
                </Typography>
                <Typography variant="body1" className="text-green-100">
                  {isEditMode
                    ? "Update existing PM scheme details"
                    : "Add new PM scheme to the system"}
                </Typography>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-6 space-y-2">
                  ...
                  <textarea
                    ...
                    placeholder="Brief detail about the scheme"
                    value={details}
...
export default SchemeCentralGovt;
